...
const I18N = {
  es: {
    ...
    jv_actions_soon:'Las acciones de turno (energía, evolución, ataque…) llegan en las próximas fases.',
  ...
  en: {
    ...
    jv_actions_soon:'Turn actions (energy, evolution, attack…) arrive in upcoming phases.',
