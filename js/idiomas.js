...
const I18N = {
  es: {
    ...
    jv_actions_soon:'Toca una carta de tu mano para jugarla (Básico→Banca, Evolución, Energía) o tu Activo para retirarte. El ataque llega en la próxima fase.',
  ...
  en: {
    ...
    jv_actions_soon:'Tap a card in your hand to play it (Basic→Bench, Evolution, Energy) or your Active to retreat. Attacking arrives next phase.',
