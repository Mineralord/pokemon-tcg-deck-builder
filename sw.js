...
const SHELL_FILES = [
  ...
  './js/sonido.js', './js/efectos-dsl.js', './js/efectos-motor.js', './js/efectos-pasivos.js',
  './js/juego.js', './data/efectos-db.js', './js/juego-efectos.js', './js/juego-ia.js', './js/juego-ui.js',
