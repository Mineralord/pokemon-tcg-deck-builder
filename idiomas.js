...
const I18N = {
  es: {
    ...
    lang_btn:'🌐 EN',
    nav_col:'🗂️ Colección', nav_exp:'🔎 Explorar cartas', nav_build:'⚔️ Construir mazo', nav_legal:'✅ Legalidad', nav_saved:'💾 Mazos',
    ...
    sync_in:'Sincronizar', sync_out:'Salir', sync_ok:'Sincronización activada', sync_err:'No se pudo iniciar sesión',
    ...
    btn_clear:'🗑️ Vaciar colección', cf_clear:'¿Vaciar TODA tu colección? Esto no se puede deshacer.', to_cleared:'Colección vaciada',
  ...
  en: {
    ...
    lang_btn:'🌐 ES',
    nav_col:'🗂️ Collection', nav_exp:'🔎 Browse cards', nav_build:'⚔️ Build deck', nav_legal:'✅ Legality', nav_saved:'💾 Decks',
    ...
    sync_in:'Sync', sync_out:'Sign out', sync_ok:'Sync enabled', sync_err:'Could not sign in',
    sync_keep:'You have {n} cards on this device. Keep them in your account?\n\nOK = keep them · Cancel = start with an empty collection',
    btn_clear:'🗑️ Clear collection', cf_clear:'Clear your ENTIRE collection? This cannot be undone.', to_cleared:'Collection cleared',
