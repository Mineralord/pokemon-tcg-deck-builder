...
const I18N = {
  es: {
    ...
    px_search_ph:'Buscar cualquier carta del juego…', px_searching:'Buscando…', px_no_results:'Sin resultados.', px_add:'Añadir al PDF', px_more:'Cargar más', px_search_results:'resultados',
  ...
  en: {
    ...
    px_search_ph:'Search any card in the game…', px_searching:'Searching…', px_no_results:'No results.', px_add:'Add to PDF', px_more:'Load more', px_search_results:'results',
